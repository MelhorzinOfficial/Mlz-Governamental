...
| Área                | Proposta                                                                  |
| :------------------ | :------------------------------------------------------------------------ |
| Educação            | Aumentar o investimento em educação básica para 8% do PIB em 10 anos.     |
...
| Anticorrupção       | Criar um portal de transparência para todos os contratos públicos.        |
...
| Centro-Neutralidade | Promover diálogos com setores público, privado e sociedade civil.        |
